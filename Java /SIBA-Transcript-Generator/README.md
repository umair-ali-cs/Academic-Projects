...
Concepts Applied:
Object-Oriented Programming (Encapsulation, Inheritance, Modularity)
...
User starts the application and selects transcript generation.

Student details and academic information are entered.

Subjects are loaded dynamically based on department and semester.

Grades or marks are entered with validation.

GPA and CGPA are calculated according to predefined rules.

A transcript preview is displayed.

The transcript can be printed or exported as a PDF using the system print dialog.
